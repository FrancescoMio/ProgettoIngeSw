...
public class Stringhe {
    ...
    public static final String inserisciDataFine = "Inserire data di fine: ";
    ...
    public static final String inserimentoData = "Vuole inserire una data di inzio e fine dispo";
